...
module.exports = function (ctx) {
  return {
    ...
    build: {
      ...
      env: {
        API: ctx.dev
          ? 'http://localhost/sistema-de-tarefas/backend8/public/api/v1'
          : 'https://production/sistema-de-tarefas/backend8/public/api/v1'
      },
      // transpile: false,
    ...
    pwa: {
      ...
      manifest: {
        ...
        short_name: 'Tarefas',
        description: 'Sistema básico de gerenciamento de tarefas',
        display: 'standalone',
